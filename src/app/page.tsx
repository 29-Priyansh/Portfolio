...
export default function Home() {
  ...
  return (
    <>
      <div className="absolute top-0 z-[-2] h-screen w-screen light:bg-white bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] dark:bg-neutral-950">
        ...
        <div className="flex justify-between absolute w-full">
          <div className="overflow-visible h-screen">
            <h1 className="flex h-screen pl-20 items-center ptext-4xl sm:text-5xl md:text-6xl lg:text-9xl font-bold tracking-tighter text-transparent dark:text-transparent dark:[-webkit-text-stroke:1px_white] [-webkit-text-stroke:1px_black]">
              PRIYANSH
            </h1>
          </div>

          <div className="relative h-screen flex w-1/2 flex-col items-center justify-center rounded-lg">
            ...
            {/* </div> */}
            <OrbitingCircles iconSize={40} radius={200} speed={2}>
              <Icons.nextjs />
              <Icons.strapi />
              <Icons.openai />
              <Icons.googleDrive />
